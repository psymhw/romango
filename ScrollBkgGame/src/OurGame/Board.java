...
public class Board extends JPanel implements ActionListener, Runnable {
	...
	public Board() {
		...
		setFocusable(true);
		ImageIcon i = new ImageIcon("forest04.png");
		ImageIcon xx = new ImageIcon("E:/test.png");
		System.out.println("xx width: "+xx.getIconWidth());
		img = i.getImage();
		time = new Timer(5, this);
		time.start();
		System.out.println("Background width: "+i.getIconWidth());
