...
slides[0] = ["gallery/craft/last2_small.jpg", "Custom fitting by modification of commercial last"];
slides[1] = ["gallery/craft/mold.jpg", "Custom fitting by making a mold of the foot"];
slides[2] = ["gallery/craft/cast.jpg", "Casting for complex fitting issues"];
slides[3] = ["gallery/craft/inseaming.jpg", "Traditional craftsmanship"];
slides[4] = ["gallery/craft/welt_done.jpg", "Hightest quality construction"];
slides[5] = ["gallery/craft/bottom.jpg", "Distinctive finishing"];
