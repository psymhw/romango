...
<ul id="p7PMnav">
  ...
  <li><a href="<%=request.getContextPath()%>/instructors.do">QC</a></li>
...
<!--	<li><a href="<%=request.getContextPath()%>/gallery/linksMain.jsp">Links</a></li> -->
	...
	<li><a href="<%=request.getContextPath()%>/market.do">Invoices</a></li> 
	<li><a href="<%=request.getContextPath()%>/media.do">POs</a></li> 
	
 
  <li><a href="<%=request.getContextPath()%>/struts/members/aboutMain.jsp">Logout</a>
	      <ul>
