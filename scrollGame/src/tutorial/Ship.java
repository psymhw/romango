...
public class Ship extends Sprite {
    ...
    public Ship() {
        ...
        // Load one image.
        Image shipImage = new Image(getClass().getResourceAsStream("/resources/images/ship.png"));
       ...
       RotatedShipImage firstShip = (RotatedShipImage)directionalShips.get(0);
        firstShip.prev = prev;
        prev.next = firstShip;
    ...
    private RotatedShipImage getCurrentShipImage() {
        return (RotatedShipImage)directionalShips.get(uIndex);
    }
   ...
   public void plotCourse(double screenX, double screenY, boolean thrust) {
    ...
    private void turnShip() {
        ...
        RotatedShipImage startImage = (RotatedShipImage)directionalShips.get(uIndex);
        RotatedShipImage endImage = (RotatedShipImage)directionalShips.get(vIndex);
    ...
    public Missile fire() {
        ...
        RotatedShipImage shipImage = (RotatedShipImage)directionalShips.get(uIndex);
